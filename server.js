...
if (!process.env.FIREBASE_SERVICE_ACCOUNT) {
  ...
  process.exit(1); // Stop the server from crashing cryptically
}
...
// --- CRITICAL CORS FIX ---
// This explicitly allows requests from any website (like your GitHub Pages test site)
app.use(cors({
  origin: '*',
...
// Simple GET route to test if the server is online
app.get('/', (req, res) => {
